<div class="col-md-4">
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">添加新的分类目录</h3>
        </div>

        <form class="form-horizontal"
              action="{{ url.get({'for':'new-taxonomy', 'type':type}) }}" method="post">
            <div class="box-body">
                <div class="form-group">
                    <label for="inputUser" class="col-sm-3 control-label">名称</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="inputEmail" class="col-sm-3 control-label">别名</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">父级分类目录</label>
                    <div class="col-sm-9">
                        <select class="form-control" name="parent" autocomplete="on">
                            {{ categoryTree }}
                        </select>
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-info pull-right">添加新的分类目录</button>
            </div>
        </form>
    </div>
</div>

{{ partial('taxonomy/taxonomy_table', {'table_title':'分类列表'}) }}