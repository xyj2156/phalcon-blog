<div class="col-md-4">
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">添加新的链接分类目录</h3>
        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="name" class="form-control" id="name"
                               placeholder="名称" autocomplete="on">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="slug" class="form-control" id="slug"
                               placeholder="别名" autocomplete="on">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" id="desc" rows="3"
                                  placeholder="写一点东西吧..." name="description"
                                  autocomplete="on"></textarea>
                        <span class="help-block">关于该链接分类的描述。</span>
                    </div>
                </div>
            </div>
...
{{ partial('taxonomy/taxonomy_table', {'table_title':'链接分类目录'}) }}
