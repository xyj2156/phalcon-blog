    ...
    public function indexAction ($show = 'all')
    {
        ...
        $this->view->setVars(
            [
                "activeShow"   => $show,
                "static"       => $static,
                "categoryTree" => treeHtml($categoryTree, 'term_taxonomy_id', 'name', '<option value="0">所有分类</option>',
                    0, $categorySelected),
    ...
    public function editAction ()
    {
        ...
        $this->view->setVars(
            [
                ...
                "ajaxUri"          => $this->url->getBaseUri(),
                "categoryTree"     => treeHtmlMultiSelect($categoryTree, 'term_taxonomy_id', 'name', ' ', 0,
                    $taxonomy['category'], ' '),
                "categoryTreeNbsp" => treeHtml($categoryTree, 'term_taxonomy_id', 'name'),
                "tagsTree"         => treeHtmlMultiSelect($tagsTree, 'term_taxonomy_id', 'name', ' ', 0,
                    $taxonomy['tag'], ' '),
